		...
		try {
			...
			if (rset != null)
				while (rset.next()) {
					...
					arraylist.add(6,
							new Integer(rset.getInt("give_dragonknight")));// 龙骑士
					arraylist.add(7,
							new Integer(rset.getInt("give_illusionist")));// 幻术士
					arraylist.add(8,
							getArray(rset.getString("getItem"), TOKEN, 1));// 奖励道具
					arraylist.add(9,
							getArray(rset.getString("count"), TOKEN, 1));// 奖励道具(数量)
					arraylist.add(10,
							getArray(rset.getString("enchantlvl"), TOKEN, 1));// 奖励道具(强化值、次数)
