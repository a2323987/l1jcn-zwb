...
public class Place {
    public static String[] Crown() throws SQLException { //王族等级排序
        String no1 = "空缺";
        String no2 = "空缺";
        String no3 = "空缺";
        String no4 = "空缺";
...
// 主要内容有：GM不列入排序、筛选出王族男女CLASSID、经验值由大到小排列。因为等级是依照经验值来计算的，所以不搜寻等级，而搜寻经验值，同等级经验值高者名次较前。最后是从第一笔往下取一笔资料、从第二笔往下取一笔资料这样。)
    ...
    public static String[] Elf() throws SQLException { //妖精等级排序
        String no1 = "空缺";
        String no2 = "空缺";
        String no3 = "空缺";
        String no4 = "空缺";
...
// 主要内容有：GM不列入排序、筛选出妖精男女CLASSID、经验值由大到小排列。因为等级是依照经验值来计算的，所以不搜寻等级，而搜寻经验值，同等级经验值高者名次较前。最后是从第一笔往下取一笔资料、从第二笔往下取一笔资料这样。)
    ...
    public static String[] Wizard() throws SQLException { //法师等级排序
        String no1 = "空缺";
        String no2 = "空缺";
        String no3 = "空缺";
        String no4 = "空缺";
...
// 主要内容有：GM不列入排序、筛选出法师男女CLASSID、经验值由大到小排列。因为等级是依照经验值来计算的，所以不搜寻等级，而搜寻经验值，同等级经验值高者名次较前。最后是从第一笔往下取一笔资料、从第二笔往下取一笔资料这样。)
    ...
    public static String[] Knight() throws SQLException { //骑士等级排序
        String no1 = "空缺";
        String no2 = "空缺";
        String no3 = "空缺";
        String no4 = "空缺";
...
// 主要内容有：GM不列入排序、筛选出骑士男女CLASSID、经验值由大到小排列。因为等级是依照经验值来计算的，所以不搜寻等级，而搜寻经验值，同等级经验值高者名次较前。最后是从第一笔往下取一笔资料、从第二笔往下取一笔资料这样。)
    ...
    public static String[] Darkelf() throws SQLException { //黑妖等级排序
        String no1 = "空缺";
        String no2 = "空缺";
        String no3 = "空缺";
        String no4 = "空缺";
...
// 主要内容有：GM不列入排序、筛选出黑妖男女CLASSID、经验值由大到小排列。因为等级是依照经验值来计算的，所以不搜寻等级，而搜寻经验值，同等级经验值高者名次较前。最后是从第一笔往下取一笔资料、从第二笔往下取一笔资料这样。)
    ...
    public static String[] Dragon() throws SQLException { //龙骑士等级排序
        String no1 = "空缺";
        String no2 = "空缺";
        String no3 = "空缺";
        String no4 = "空缺";
...
// 主要内容有：GM不列入排序、筛选出龙骑士男女CLASSID、经验值由大到小排列。因为等级是依照经验值来计算的，所以不搜寻等级，而搜寻经验值，同等级经验值高者名次较前。最后是从第一笔往下取一笔资料、从第二笔往下取一笔资料这样。)
    ...
    public static String[] Illusionist() throws SQLException { //幻术师等级排序
        String no1 = "空缺";
        String no2 = "空缺";
        String no3 = "空缺";
        String no4 = "空缺";
