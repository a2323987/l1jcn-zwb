	...
	private void countdown() {
		...
		try {
			while (secondsShut > 0) {
				...
				switch (secondsShut) {
				case 240:
					_an.announceToAll("伺服器将于 4 分钟后爆炸!!请至安全区域准备登出。");
					 System.out.println( "伺服器将于 4 分钟后爆炸!!" );     
					break;
				case 180:
					_an.announceToAll("伺服器将于 3 分钟后爆炸!!请至安全区域准备登出。");
					 System.out.println( "伺服器将于 3 分钟后爆炸!!" );     
					break;
				case 120:
					_an.announceToAll("伺服器将于 2 分钟后爆炸!!请至安全区域准备登出。");
					 System.out.println( "伺服器将于 2 分钟后爆炸!!" );     
					break;
				case 60:
					_an.announceToAll("伺服器将于 1 分钟后爆炸!!请至安全区域准备登出。");
					 System.out.println( "伺服器将于 1 分钟后爆炸!!" );     
					break;
				case 30:
					_an.announceToAll("伺服器将于 30 秒后爆炸!!");
					 System.out.println( "伺服器将于 30 秒后爆炸!!" );     
					break;
				case 10:
					_an.announceToAll("伺服器将于 10 秒后爆炸!!");
					 System.out.println( "伺服器将于 10 秒后爆炸!!" );     
					break;
				case 5:
					_an.announceToAll("伺服器将于 5 秒后爆炸!!");
					 System.out.println( "伺服器将于 5 秒后爆炸!!" );     
					break;
				case 4:
					_an.announceToAll("伺服器将于 4 秒后爆炸!!");
					 System.out.println( "伺服器将于 4 秒后爆炸!!" );     
					break;
				case 3:
					_an.announceToAll("伺服器将于 3 秒后爆炸!!");
					 System.out.println( "伺服器将于 3 秒后爆炸!!" );     
					break;
				case 2:
					_an.announceToAll("伺服器将于 2 秒后爆炸!!");
					 System.out.println( "伺服器将于 2 秒后爆炸!!" );     
					break;
				case 1:
					_an.announceToAll("伺服器将于 1 秒后爆炸!!");
					 System.out.println( "伺服器将于 1 秒后爆炸!!" );     
					break;
				}
