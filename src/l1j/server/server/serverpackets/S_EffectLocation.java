...
public class S_EffectLocation extends ServerBasePacket {
	...
	/**
	 * 指定された位置へエフェクトを表示するパケットを构筑する。
	 * 
	 * @param pt - エフェクトを表示する位置を格纳したPointオブジェクト
	 ...
	 * 指定された位置へエフェクトを表示するパケットを构筑する。
	 * 
	 * @param loc - エフェクトを表示する位置を格纳したL1Locationオブジェクト
	 * @param gfxId - 表示するエフェクトのID
	 */
	 ...
	 * 指定された位置へエフェクトを表示するパケットを构筑する。
	 * 
	 * @param x - エフェクトを表示する位置のX座标
	 * @param y - エフェクトを表示する位置のY座标
	 * @param gfxId - 表示するエフェクトのID
	 */
