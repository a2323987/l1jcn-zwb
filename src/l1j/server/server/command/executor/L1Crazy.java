...
public class L1Crazy implements L1CommandExecutor {
	...
	public void execute(L1PcInstance pc, String cmdName, String arg) {
		int[] allBuffSkill =
		{  PHYSICAL_ENCHANT_DEX, PHYSICAL_ENCHANT_STR, BLESS_WEAPON, BERSERKERS,  ADVANCE_SPIRIT,
				ENCHANT_VENOM, BURNING_SPIRIT,DOUBLE_BRAKE,
				DRESS_EVASION, GLOWING_AURA, BRAVE_AURA, BURNING_WEAPON, 
				EXOTIC_VITALIZE, ELEMENTAL_FIRE, SOUL_OF_FLAME, ADDITIONAL_FIRE };
		try {
			...
			pc.sendPackets(new S_SystemMessage("请输入 .crazy 玩家名称。"));
		}
	}
}
