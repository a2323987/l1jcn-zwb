...
public class L1MobSkill implements Cloneable {
	...
	/*
	 * スキルのタイプ 0→何もしない、1→物理攻击、2→魔法攻击、3→サモン
	 */
	private int type[];
	...
	/*
	 * スキル発动条件：triRange<0の场合、对象との距离がabs(triRange)以下のとき発动
	...
	// distanceが指定idxスキルの発动条件を满たしているか
