...
public class L1PetInstance extends L1NpcInstance {
	...
	// 宠物装备经验加倍功能
	private int _exptateByWeapon;

	public void setExpRateByWeapon(int i) {
		_exptateByWeapon = i;
	}

	public int getExpRateByWeapon() {
		return _exptateByWeapon;
	}
	
	private int _exptateByArmor;

	public void setExpRateByArmor(int i) {
		_exptateByArmor = i;
	}

	public int getExpRateByArmor() {
		return _exptateByArmor;
	}
	// end
	// 宠物饱食度计时器
	...
	private void setPetWeapon(L1PetInstance pet, L1ItemInstance weapon) {
		...
		pet.setExpRateByWeapon(petItem.getExpRate()); // 宠物装备经验加倍功能
	...
	private void setPetArmor(L1PetInstance pet, L1ItemInstance armor) {
		...
		pet.addSp(petItem.getAddSp());
		pet.addMr(petItem.getAddMr());
		pet.setExpRateByArmor(petItem.getExpRate()); // 宠物装备经验加倍功能
