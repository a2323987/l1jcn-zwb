...
public class L1TownLocation {
	...
	{ new Point(32601, 32757), new Point(32625, 32809), new Point(32611, 32727), new Point(32612, 32781), new Point(32605, 32761), // 修正使用重登回村时在古鲁丁村庄会卡在草中 by  by 9001183ex
	...
	public static int[] getGetBackLoc(int town_id) { // town_idから归还先の座标をランダムに返す
		int[] loc = new int[3];
		...
		else if (town_id == TOWNID_RECLUSE_VILLAGE) { // 隐れ里
