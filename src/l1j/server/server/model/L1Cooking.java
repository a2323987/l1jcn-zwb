...
public class L1Cooking {
	...
	public static void eatCooking(L1PcInstance pc, int cookingId, int time) {
		...
		else if ((cookingId == COOKING_1_2_N) || (cookingId == COOKING_1_2_S)) { // ナッツ饼
			cookingType = 2;
		}
		else if ((cookingId == COOKING_1_3_N) || (cookingId == COOKING_1_3_S)) { // 蚁脚のチーズ烧き
			cookingType = 3;
			pc.addAc(-1);
		...
		else if ((cookingId == COOKING_1_6_N) || (cookingId == COOKING_1_6_S)) { // 猪肉の串烧き
			cookingType = 6;
			pc.addMr(5);
		...
		else if ((cookingId == COOKING_2_3_N) || (cookingId == COOKING_2_3_S)) { // キウィパロット烧き
			cookingType = 11;
		}
		else if ((cookingId == COOKING_2_4_N) || (cookingId == COOKING_2_4_S)) { // スコーピオン烧き
			cookingType = 12;
		}
		...
		else if ((cookingId == COOKING_2_6_N) || (cookingId == COOKING_2_6_S)) { // クモ脚の串烧き
			cookingType = 14;
			pc.addSp(1);
			pc.sendPackets(new S_SPMR(pc));
		}
		...
		else if ((cookingId == COOKING_3_0_N) || (cookingId == COOKING_3_0_S)) { // クラスタシアンのハサミ烧き
			cookingType = 16;
		}
		else if ((cookingId == COOKING_3_1_N) || (cookingId == COOKING_3_1_S)) { // グリフォン烧き
			cookingType = 17;
			pc.addMaxHp(50);
			pc.sendPackets(new S_HPUpdate(pc.getCurrentHp(), pc.getMaxHp()));
			if (pc.isInParty()) { // パーティー中
		...
		else if ((cookingId == COOKING_3_3_N) || (cookingId == COOKING_3_3_S)) { // タートルドラゴン烧き
			cookingType = 19;
			pc.addAc(-3);
			pc.sendPackets(new S_OwnCharStatus(pc));
		}
		...
		else if ((cookingId == COOKING_3_5_N) || (cookingId == COOKING_3_5_S)) { // ドレイク烧き
			cookingType = 21;
			pc.addSp(2);
			pc.sendPackets(new S_SPMR(pc));
		}
		else if ((cookingId == COOKING_3_6_N) || (cookingId == COOKING_3_6_S)) { // 深海鱼のシチュー
			cookingType = 22;
			pc.addMaxHp(30);
			pc.sendPackets(new S_HPUpdate(pc.getCurrentHp(), pc.getMaxHp()));
			if (pc.isInParty()) { // パーティー中
