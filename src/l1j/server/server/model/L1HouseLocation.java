...
public class L1HouseLocation {
	...
	{ new Point(33966, 33253), new Point(33921, 33177), // 仓库、ペット保管所
			new Point(33553, 32712), new Point(32702, 32842), }; // 赎罪の使者、ギラン市场
	...
	public static int[] getHouseLoc(int houseId) { // houseIdからアジトの座标を返す
		int[] loc = new int[3];
		if (houseId == 262145) { // ギランアジト1
			loc[0] = 33374;
			loc[1] = 32657;
	...
	public static int[] getBasementLoc(int houseId) { // houseIdからアジトの地下室の座标を返す
		int[] loc = new int[3];
	...
	public static int[] getHouseTeleportLoc(int houseId, int number) { // houseIdからテレポート先の座标を返す
		int[] loc = new int[3];
