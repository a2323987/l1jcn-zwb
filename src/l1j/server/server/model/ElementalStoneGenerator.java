...
public class ElementalStoneGenerator implements Runnable {
	...
	private static final int SLEEP_TIME = 300; // 设置终了后、再设置までのスリープ时间 秒
	...
	private static final int ELEMENTAL_STONE_ID = 40515; // 精灵の石
	...
	public void run() {
		try {
			...
			while (true) {
				...
				while (_itemList.size() < MAX_COUNT) { // 减っている场合セット
