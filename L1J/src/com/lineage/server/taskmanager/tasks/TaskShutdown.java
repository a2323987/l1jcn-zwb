...
public class TaskShutdown extends Task {
     ...
     * (non-Javadoc)
     * 
     * @see com.lineage.server.taskmanager.Task#getName()
     */
    @Override
