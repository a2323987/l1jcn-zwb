...
public class C_GiveItem extends ClientBasePacket {
    ...
    /** 吃食物 */
    private void eatFood(final L1PcInstance pc, final L1NpcInstance target,
            final L1ItemInstance item, final int count) {
    ...
    /** 进化宠物 */
    private void evolvePet(final L1PcInstance pc, final L1NpcInstance target,
            final int itemId) {
        if (!(target instanceof L1PetInstance)) {
            return;
        }
    ...
    /** 使用宠物武器防具 */
    private void usePetWeaponArmor(final L1NpcInstance target,
