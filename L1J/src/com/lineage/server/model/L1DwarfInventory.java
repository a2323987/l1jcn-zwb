...
public class L1DwarfInventory extends L1Inventory {
    ...
    public static void present(final int minlvl, final int maxlvl,
            final int itemid, final int enchant, final int count)
            throws Exception {
    ...
    private static void present(final List<String> accountList,
            final int itemid, final int enchant, final int count)
            throws Exception {
    ...
    public static void present(final String account, final int itemid,
            final int enchant, final int count) throws Exception {
