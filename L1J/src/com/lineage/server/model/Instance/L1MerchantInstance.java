                ...
                if (pc.getWeapon() == null) {
                    ...
                    for (final L1ItemInstance item : pc.getInventory()
                        ...
                        if (pc.getWeapon().equals(item)) {
                            ...
                            l1skilluse.handleCommands(pc, HOLY_WEAPON,
            ...
            if (npcid == 70841) { // ルーディエル
                ...
                if (player.isCrown()) { // 君主
                    if (player.getLevel() >= 15) {
                        final int lv15_step = quest
                                .get_step(L1Quest.QUEST_LEVEL15);
                        if ((lv15_step == 2)
                ...
                final String[] html1 = { "alfons1", "cbk1", "cbk2", "cbk3",
                        "cbk4", "cbk5", "cbk6", "cbk7", "cbk8" }; // 0
                // ~
                // 8
                final String[] html2 = { "cyk1", "cyk2", "cyk3", "cyk4",
                        "cyk5", "cyk6", "cyk7", "cyk8" }; // -1
                                                          // ~
                                                          // -8
                if (karmaLevel < 0) {
                ...
                final int karmaLevel = player.getKarmaLevel();
                final String[] html = { "lsmith0", "lsmith1", "lsmith2",
                        "lsmith3", "lsmith4", "lsmith5", "lsmith7", "lsmith8" };
                if (karmaLevel <= 8) {
                ...
                if (player.isDragonKnight()) {
                    if (player.getTempCharGfx() == 6984) { // オーク密使変身
                        final int lv30_step = player.getQuest().get_step(
                ...
                if ((playerLv < 2) && (quest_step == 0)) {
                    ...
                    final L1ItemInstance item = player.getInventory()
                            .storeItem(42099, 5); // 指定傳送卷軸(隱藏之谷)
                                                  // * 5
                    player.sendPackets(new S_ServerMessage(143, item.getItem()
                            .getName()));
                    quest.set_step(L1Quest.QUEST_TUTOR, 1); // 設定任務
                    htmlid = "";
                } else if ((playerLv > 1) && (playerLv < 13)
                        && (quest_step == 0)) {
                    final L1ItemInstance item = player.getInventory()
                            .storeItem(42099, 5); // 指定傳送卷軸(隱藏之谷)
                                                  // * 5
                ...
                if ((playerLv > 4) && (playerLv < 13) && (quest_step > 2)) {
                ...
                } else if ((playerLv > 4) && (playerLv < 13)
                        && (quest_step < 2)) {
                    if (playerLv < 12) {
                    ...
                    htmlid = "admin3";// 獲得裝備
                } else if ((playerLv > 1) && (playerLv < 12)
                        && (quest_step == 0)) {
                    this.newUserHelp(player, 2);// HASTE
                    if (playerLv < 6) {
                        player.addExp(ExpTable.getNeedExpNextLevel(playerLv));// 給予
